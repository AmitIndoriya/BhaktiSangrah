...
public class SuderKandRVAdapter2 extends RecyclerView.Adapter<SuderKandRVAdapter2.MyView> {

    List<SunderKaandBean.SunderKandArray.Doha> dohaList;
    ...
    public SuderKandRVAdapter2(Context context, List<SunderKaandBean.SunderKandArray.Doha> dohaList) {
        this.context = context;
        resources = context.getResources();
        this.dohaList = dohaList;
    }
    ...
    public void onBindViewHolder(final MyView holder, final int position) {
        SunderKaandBean.SunderKandArray.Doha doha = dohaList.get(position);
        holder.contentTV.setText(doha.getDoha());
        holder.contentMeaningTV.setText(doha.getMeaning());
    }
